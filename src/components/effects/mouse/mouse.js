...
-------------------------------------------------------------------------------------------------------------------
data-fls-mouse-cx="коэффициент_x"                100                         большее значение - меньший процент сдвига
data-fls-mouse-cy="коэффициент_y"                100                         большее значение - меньший процент сдвига
data-fls-mouse-dxr                                                            против оси X
data-fls-mouse-dyr                                                            против оси Y
data-fls-mouse-a="скорость_анимации"             50                          большее значение - выше скорость

// =========
Если нужно считывать движение мыши в блоке-родителе - родителю указать атрибут data-fls-mouse-mouse-wrapper
...
class MousePRLX {
  ...
  paralaxMouseInit(paralaxMouse) {
    paralaxMouse.forEach(el => {
      ...
      // Коэфф. X
      const paramCoefficientX = el.dataset.flsMouseCx ? +el.dataset.flsMouseCx : 100;
      // Коэфф. Y
      ...
      // Проверяю наличие родителя, в котором считывается положение мыши
      ...
      function setMouseParallaxStyle() {
        ...
        el.style.cssText = `transform: translate3D(${directionX * positionX / (paramCoefficientX / 10)}%,${directionY * positionY / (paramCoefficientY / 10)}%,0) rotate(0.02deg);`;
